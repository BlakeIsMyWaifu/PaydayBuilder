...
const equipments: Record<string, EquipmentData> = {
	...
	'Ordnance Bag': {
		name: 'Ordnance Bag', // ! image grayscale
		amount: [1],
		upgrade: [],
		description: [
			`To use the Ordnance Bag, you need to place it by holding [${keybinds['Deploy Equipment/Throw Bag']}]. Once placed it cannot be moved, but it may be used by both you and your crew. While in close proximity to the Ordnance Bag, hold [${keybinds['Shout/Interact']}] to replenish throwable items. It can only be used four times.`,
