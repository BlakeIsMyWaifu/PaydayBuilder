...
const payday2Community: Record<Payday2CommunityList, MaskData<Payday2CommunityList, CommunityCollectionList>> = {
	'Mark': {
		name: 'Mark',
		image: 'bear',
		description: [
	...
	'Smiley': {
		...
		image: 'smiley',
		description: [
			'There was once a clown who couldn\'t smile. He watched as the other clowns brought joy and happiness to both young and old. He grew envious and angry, so to the point that he stapled his lips to his cheeks, giving him a wide grin. But instead of making everyone happy, they were all afraid, why, he did not understand.',
...
export default payday2Community