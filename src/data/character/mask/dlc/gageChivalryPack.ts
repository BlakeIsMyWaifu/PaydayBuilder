...
export type GageChivalryPackList =
	| 'Agatha Knight Veteran'
	| 'Agatha Vanguard Veteran'
	| 'Mason Knight Veteran'
	| 'Mason Vanguard Veteran'

const gageChivalryPack: Record<GageChivalryPackList, MaskData<GageChivalryPackList, DlcCollectionList>> = {
	'Agatha Knight Veteran': {
...
export default gageChivalryPack