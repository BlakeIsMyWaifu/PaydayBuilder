...
export type GageHistoricalPackList =
	| 'British Bulldog'
	| 'Old Blood and Guts'
	| 'The Constable'
	| 'The Red Bear'

const gageHistoricalPack: Record<GageHistoricalPackList, MaskData<GageHistoricalPackList, DlcCollectionList>> = {
	'British Bulldog': {
		...
		collection: 'Gage Historical Pack',
...
export default gageHistoricalPack