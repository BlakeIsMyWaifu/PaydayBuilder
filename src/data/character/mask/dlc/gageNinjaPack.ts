...
export type GageNinjaPackList =
	| 'Kage'
	| 'Kuro Zukin'
	| 'Shirai'
	| 'Slicer'

const gageNinjaPack: Record<GageNinjaPackList, MaskData<GageNinjaPackList, DlcCollectionList>> = {
	'Kage': {
		name: 'Kage',
		image: 'kage',
		description: [
