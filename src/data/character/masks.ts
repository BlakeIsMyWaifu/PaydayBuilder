...
const masks: Record<string, MaskData> = {
	...
	'Kitsune Kari': {
		...
		image: 'foxfurhat',
		description: [
			'It\'s important to kepp in touch with nature, so why the hell not bring a piece of it with you? Though not truly on a fox hunt, you are out there hunting down that loot.'
		],
		collection: 'Winter Ghosts Tailor Pack',
		rarity: 'Paid',
		unlock: 'THIS IS A WINTER GHOSTS TAILOR PACK ITEM!',
	...
	'PermaFrost': {
		...
		image: 'iceskull',
		description: [
			'Keeping a cool head while the bullets are flying has never looked more terrifying. This one will scare the hell out of anyone facing you. Mabey even more so than your gun does.'
		],
		collection: 'Winter Ghosts Tailor Pack',
		rarity: 'Paid',
		unlock: 'THIS IS A WINTER GHOSTS TAILOR PACK ITEM!',
	...
	'Shady Business': {
		...
		image: '???',
		description: [
			'If you\'ve got the suit, you need the matching eye protection to dangle from your nose-bridge, right? The Combinded cool-factor of Clowns and Saints coming together might just be enough to cause a cosmic paradox and implode the entire universe. (Just don\'t ask Aldstone to clean up the mess, OK?)'
		],
